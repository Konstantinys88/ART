...
/* harmony import */ var _modules_showMoStyles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/showMoStyles */ "./src/js/modules/showMoStyles.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_showMoStyles__WEBPACK_IMPORTED_MODULE_5__["default"])(".button-styles", "#styles .row");
...
var accordion = function accordion() {
  ...
  parentSelector.addEventListener("click", function (e) {
    ...
    } catch (_unused) {// console.error(error);
    }
  }); // btns.forEach(btn => {
...
var checkTextInputs = function checkTextInputs(selector) {
  ...
  txtInputs.forEach(function (input) {
    ...
    input.addEventListener('blur input', function (e) {
      e.preventDefault(); // input.value.replace(/[a-zA-Z]/ig, "");
    });
  });
};
...
var drop = function drop() {
  ...
  function highligt(item) {
    item.closest('.file_upload').style.border = "5px solid yellow";
    item.closest('.file_upload').style.backgroundColor = "rgba(0,0,0 .7)";
  }

  function unhighligt(item) {
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      textMessage.textContent = messege.loading;
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        textMessage.textContent = messege.success;
      }).catch(function () {
...
/***/ "./src/js/modules/showMoStyles.js":
/*!****************************************!*\
  !*** ./src/js/modules/showMoStyles.js ***!
  \****************************************/
/*! exports provided: default */
...
var showMoStyles = function showMoStyles(trigger, wrapper) {
...
/* harmony default export */ __webpack_exports__["default"] = (showMoStyles); // <div class="hidden-lg hidden-md hidden-sm hidden-xs styles-2">
// <div class=styles-block>
...
/**
 * Слайдер
 * @param {*} slides селектор для слайдов
 * @param {*} dir нправление слайдера если вертикальное указаьть "vertical" иначе горизоньальное
 * @param {*} prev селектор кнопки вперед
 * @param {*} next селектор кнопки назад
 */
